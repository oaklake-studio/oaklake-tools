...
Once installed, just ask Claude: *"make a demo gif of the checkout flow"* — it invokes the skill, asks for the base URL / login / beats, and produces the GIF. Not for terminal/CLI recordings, and not for real third-party SSO logins on camera (see the skill's hybrid-capture note).
